...
namespace Game.Editor.DataTable
{
    public static class ExtensionsGenerate
    {
            ...
            IDictionary<string, DataTableProcessor.DataProcessor> dataProcessors)
        {
            ...
            sb.AppendLine("\t}");
            sb.AppendLine("}");
            GenerateCodeFile("DataTableExtension.Array", sb.ToString().Replace("\t","    "));
        }
            ...
            IDictionary<string, DataTableProcessor.DataProcessor> dataProcessors)
        {
            ...
            sb.AppendLine("\t}");
            sb.AppendLine("}");
            GenerateCodeFile("DataTableExtension.List", sb.ToString().Replace("\t","    "));
        }
            ...
            IDictionary<string, DataTableProcessor.DataProcessor> dataProcessors)
        {
            ...
            sb.AppendLine("\t}");
            sb.AppendLine("}");
            GenerateCodeFile("BinaryReaderExtension.List", sb.ToString().Replace("\t","    "));
        }
            ...
            IDictionary<string, DataTableProcessor.DataProcessor> dataProcessors)
        {
            ...
            sb.AppendLine("\t}");
            sb.AppendLine("}");
            GenerateCodeFile("BinaryReaderExtension.Array", sb.ToString().Replace("\t","    "));
        }
        ...
        private static void GenerateDataTableExtensionDictionary(List<DataTableProcessor.DataProcessor[]> keyValueList)
        {
            ...
            sb.AppendLine("\t}");
            sb.AppendLine("}");
            GenerateCodeFile("DataTableExtension.Dictionary", sb.ToString().Replace("\t","    "));
        }
            ...
            List<DataTableProcessor.DataProcessor[]> keyValueList)
        {
            ...
            sb.AppendLine("\t}");
            sb.AppendLine("}");
            GenerateCodeFile("BinaryReaderExtension.Dictionary", sb.ToString().Replace("\t","    "));
        }
