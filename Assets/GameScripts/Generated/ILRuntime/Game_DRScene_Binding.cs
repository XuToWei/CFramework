...
{
    unsafe class Game_DRScene_Binding
    {
        ...
        static StackObject* get_AssetName_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            Game.DRScene instance_of_this_method = (Game.DRScene)typeof(Game.DRScene).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
