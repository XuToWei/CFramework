...
namespace Game
{
    public static partial class AwaitableExtension
    {
        ...
        /// 加载热更数据表（可等待）
        /// </summary>
        public static async Task<IDataTable<DRHotfix>> LoadHotfixDataTableAsync(
            this DataTableComponent dataTableComponent, string dataTableName, string dataTableAssetName,
            object userData)
        {
#if UNITY_EDITOR
            TipsSubscribeEvent();
